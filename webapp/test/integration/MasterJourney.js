sap.ui.define([
	...
	opaTest("MasterList Filtering on Lneam less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("Lneam").
		and.iSelectListItemInViewSettingsDialog("<100 Dccur").
	...
	opaTest("MasterList Filtering on Lneam more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 Dccur").
		and.iPressOKInViewSelectionDialog();
