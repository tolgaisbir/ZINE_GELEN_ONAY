sap.ui.define([
	...
	return BaseController.extend("ZINE.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("GELENONAYSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("GELENONAYSet", oData);
