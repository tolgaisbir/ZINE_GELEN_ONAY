sap.ui.define([
	...
	return BaseObject.extend("ZINE.model.ListSelector", {
		 ...
		 * @return {ZINE.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
